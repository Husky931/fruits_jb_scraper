...
logging.basicConfig(filename='/home/ubuntu/fruits_jb_scraper/monster/logs/uk_farmassistant.log', level=logging.INFO, format='%(asctime)s - %(message)s')
...
headers = {
    ...
    "Origin": "https://www.monster.co.uk",
    "Referer": "https://www.monster.co.uk/jobs/search?q=farm+assistant&where=&page=3&so=m.h.s",
    "Sec-Ch-Ua": sec_ch_ua,
    "Sec-Ch-Ua-Mobile": "?0",
