...
logging.basicConfig(filename='/home/ubuntu/fruits_jb_scraper/monster/logs/sweden_fruktskördare.log', level=logging.INFO, format='%(asctime)s - %(message)s')

url = "https://appsapi.monster.io/jobs-svx-service/v2/monster/search-jobs/samsearch/sv-SE?apikey=AE50QWejwK4J73X1y1uNqpWRr2PmKB3S"
...
headers = {
    ...
    "Origin": "https://www.monster.se",
    "Referer": "https://www.monster.se/jobb/sok?q=Fruktsk%C3%B6rdare&where=&page=3&so=m.h.s",
    "Sec-Ch-Ua": sec_ch_ua,
    "Sec-Ch-Ua-Mobile": "?0",
...
payload = {
    ...
    "fingerprintId": "z7c62d634f3df0e8a355e7edd61a5a303",
    "offset": 9,
    "pageSize": 9,
